...
const buildVersion = shellJs.exec("git rev-parse --short HEAD", { encoding: "utf-8", silent: true }).stdout;
buildInfo.buildVersion = buildVersion.trim();

fs.writeFileSync(path.join(dest, "assets", "version.txt"), JSON.stringify(buildInfo));
